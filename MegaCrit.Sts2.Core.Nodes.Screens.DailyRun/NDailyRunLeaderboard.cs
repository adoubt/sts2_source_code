...
public class NDailyRunLeaderboard : Control
{
	...
	protected override void RestoreGodotObjectData(GodotSerializationInfo info)
	{
		...
		if (info.TryGetProperty(PropertyName._currentPage, out var value9))
		{
			_currentPage = value9.As<int>();
		}
		if (info.TryGetProperty(PropertyName._hasNegativeScore, out var value10))
		{
			_hasNegativeScore = value10.As<bool>();
		}
	}
}
